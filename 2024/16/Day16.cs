...
public class Day16
{
    ...
    public object Part2(string input)
    {
        ...
        return positions
            ...
            .Count(n =>
            {
                var yes = Vector.DirectionsVonNeumann<Vector2>()
                    .Any(d => IsOnCheapestPath((n, d)));
        ...
        {
            if (CheapestToEnd(position, out var costToEnd) && costToEnd <= cheapest && CheapestFromStart(position, out var costToStart))
            {
